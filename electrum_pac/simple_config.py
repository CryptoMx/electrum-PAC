...
FEERATE_WARNING_HIGH_FEE = 10000000000
FEERATE_FALLBACK_STATIC_FEE = 1000
FEERATE_DEFAULT_RELAY = 5000000000
FEERATE_STATIC_VALUES = [5000000000, 7000000000, 9000000000, 10000000000, 15000000000, 20000000000, 28000000000, 32000000000, 40000000000, 50000000000]
...
class SimpleConfig(PrintError):
    ...
    def electrum_path(self):
        ...
        self.print_error("electrum-pac directory", path)
        return path
    ...
    def convert_version_3(self):
        ...
        if isinstance(base_unit, str):
            ...
            map_ = {'pac':8, 'mpac':5, 'upac':2, 'duffs':0, 'sat':0}
