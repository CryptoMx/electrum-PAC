...
from electrum_pac.util import profiler, parse_URI, format_time, InvalidPassword, NotEnoughFunds, Fiat
from electrum_pac import bitcoin
from electrum_pac .transaction import TxOutput
from electrum_pac.util import timestamp_to_datetime
...
class CScreen(Factory.Screen):
    ...
    def load_screen(self):
        self.screen = Builder.load_file('electrum_pac/gui/kivy/uix/ui_screens/' + self.kvname + '.kv')
...
class HistoryScreen(CScreen):
    ...
    def get_card(self, tx_hash, tx_mined_status, value, balance):
        ...
        icon = "atlas://electrum_pac/gui/kivy/theming/light/" + TX_ICONS[status]
...
class SendScreen(CScreen):
    ...
    def set_URI(self, text):
        ...
        import electrum_pac
        try:
            uri = electrum_pac.util.parse_URI(text, self.app.on_pr)
        except:
    ...
    def do_save(self):
        ...
        from electrum_pac.paymentrequest import make_unsigned_request, PaymentRequest
...
class ReceiveScreen(CScreen):
    ...
    def get_URI(self):
        from electrum_pac.util import create_URI
