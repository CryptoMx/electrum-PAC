...
from electrum_pac.bitcoin import TYPE_ADDRESS
from electrum_pac.storage import WalletStorage
from electrum_pac.wallet import Wallet
from electrum_pac.paymentrequest import InvoiceStore
from electrum_pac.util import profiler, InvalidPassword
from electrum_pac.plugin import run_hook
from electrum_pac.util import format_satoshis, format_satoshis_plain
...
#Factory.register('InstallWizard', module='electrum_pac.gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_pac.gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_pac.gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_pac.gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_pac_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_pac.gui.kivy.uix.screens')

# Register fonts without this you won't be able to use bold/italic...
# inside markup.
from kivy.core.text import Label
Label.register('Roboto',
               'electrum_pac/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_pac/gui/kivy/data/fonts/Roboto.ttf',
               'electrum_pac/gui/kivy/data/fonts/Roboto-Bold.ttf',
               'electrum_pac/gui/kivy/data/fonts/Roboto-Bold.ttf')


from electrum_pac.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_pac.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_pac.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_pac.util import format_time
        requestor = req.get('requestor')
        exp = req.get('exp')
        memo = req.get('memo')
        amount = req.get('amount')
        fund = req.get('fund')
        popup = Builder.load_file('electrum_pac/gui/kivy/uix/ui_screens/invoice.kv')
    ...
    def scan_qr(self, on_complete):
        ...
        SimpleScannerActivity = autoclass("org.pac.electrum.qr.SimpleScannerActivity")
    ...
    def build(self):
        return Builder.load_file('electrum_pac/gui/kivy/main.kv')
    ...
    def on_start(self):
        ...
        # bind intent for pac: URI scheme
        if platform == 'android':
            from android import activity
            from jnius import autoclass
            PythonActivity = autoclass('org.kivy.android.PythonActivity')
    ...
    def show_tor_warning(self):
        ...
        img_error = 'atlas://electrum_pac/gui/kivy/theming/light/error'
    ...
    def load_wallet_by_name(self, path, ask_if_wizard=False):
        ...
        if wallet:
            ...
            Logger.debug('Pac-Electrum: Wallet not found or action needed. Launching install wizard')
    ...
    def popup_dialog(self, name):
        if name == 'settings':
            ...
            popup = Builder.load_file('electrum_pac/gui/kivy/uix/ui_screens/'+name+'.kv')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_pac.gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_pac.gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_pac_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_pac_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-pac.png"
    ...
    def get_max_amount(self):
        from electrum_pac.transaction import TxOutput
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Pac-Electrum', message,
                            app_icon=icon, app_name='Pac-Electrum')
        except ImportError:
    ...
    def show_error(self, error, width='200dp', pos=None, arrow_pos=None,
        exit=False, icon='atlas://electrum_pac/gui/kivy/theming/light/error', duration=0,
        modal=False):
    ...
    def show_info(self, error, width='200dp', pos=None, arrow_pos=None,
        ...
        '''
        self.show_error(error, icon='atlas://electrum_pac/gui/kivy/theming/light/important',
    ...
    def show_info_bubble(self, text=_('Hello World'), pos=None, duration=0,
        ...
        if text == 'texture':
            ...
            info_bubble.background_image = 'atlas://electrum_pac/gui/kivy/theming/light/card'
        else:
