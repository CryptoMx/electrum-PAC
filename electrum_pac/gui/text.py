...
import electrum_pac
from electrum_pac.util import format_satoshis, set_verbosity
from electrum_pac.bitcoin import is_address, COIN, TYPE_ADDRESS
    ...
    def network_dialog(self):
        ...
        if out:
            ...
            if out.get('server') or out.get('proxy'):
                proxy = electrum_pac.network.deserialize_proxy(out.get('proxy')) if out.get('proxy') else proxy_config
