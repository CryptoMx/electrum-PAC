...
from electrum_pac.util import UserCancelled, InvalidPassword
from electrum_pac.base_wizard import BaseWizard, HWD_SETUP_DECRYPT_WALLET, GoBack
...
class InstallWizard(QDialog, MessageBoxMixin, BaseWizard):
    ...
    def __init__(self, config, app, plugins, storage):
        ...
        self.setWindowTitle('Pac-Electrum  -  ' + _('Install Wizard'))
        self.app = app
        self.config = config
        ...
        self.set_icon(':icons/electrum_pac.png')
        self.show()
        self.raise_()
    ...
    def run_and_get_wallet(self, get_wallet_from_daemon):
        ...
        self.set_layout(vbox, title=_('Pac-Electrum wallet'))
    ...
    def init_network(self, network):
        message = _("Pac-Electrum communicates with remote servers to get "
