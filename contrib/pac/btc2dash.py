...
imp.load_module('electrum_pac', *imp.find_module('../../electrum_pac'))

from electrum_pac import constants
from electrum_pac.bitcoin import (b58_address_to_hash160, hash160_to_b58_address,
                                  serialize_privkey, DecodeBase58Check, WIF_SCRIPT_TYPES)
from electrum_pac.util import inv_dict
