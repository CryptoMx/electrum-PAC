...
from electrum_PAC import WalletStorage, Wallet
from electrum_PAC_gui.kivy.i18n import _
...
Factory.register('InstallWizard',
                 module='electrum_PAC_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_PAC_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_PAC_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_PAC_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_PAC_gui.kivy.uix.screens')
...
from electrum_PAC.util import base_units
...
class ElectrumWindow(App):
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'm$PAC')
    ...
    def load_wallet_by_name(self, path):
        ...
        if wallet:
            ...
            Logger.debug('Electrum-PAC: Wallet not found. Launching install wizard')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_PAC_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_PAC_gui.kivy.uix.qrcodewidget')
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-PAC', message,
                            app_icon=icon, app_name='Electrum-PAC')
        except ImportError:
