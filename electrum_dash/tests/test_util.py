...
class TestUtil(SequentialTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1',
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?label=electrum%20test',
                                {'address': 'XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1', 'label': 'electrum test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?message=electrum%20test',
                                {'address': 'XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1', 'message': 'electrum test', 'memo': 'electrum test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?amount=0.0003',
                                {'address': 'XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?test=test',
                                {'address': 'XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
    ...
    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('PAC:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(BaseException, parse_URI, 'PAC:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(BaseException, parse_URI, 'notPAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1')

    def test_parse_URI_parameter_polution(self):
        self.assertRaises(Exception, parse_URI, 'PAC:XfTA9qgYmaEHfWhUakwcoTtyquez8SowY1?amount=0.0003&label=test&amount=30.0')
